...
const requestForQuotesSchema = Schema(
  {
    ...
    quotes_: [{ type: Schema.Types.ObjectId, require, ref: "planning.SolQuotes", autopopulate: true }],
    period: { type: Schema.Types.ObjectId, require, ref: "planning.period", autopopulate: true },
    items: [{ type: Schema.Types.ObjectId, require, ref: "items", autopopulate: true }],
    invitedSuppliers: [{ type: Schema.Types.ObjectId, require, ref: "planning.supplier", autopopulate: true }],
